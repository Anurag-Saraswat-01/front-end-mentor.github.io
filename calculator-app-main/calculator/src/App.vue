<template>
  <div class="container" :class="`theme${theme}`">
    <CalcContainer @switch-theme="switchTheme" :theme="theme" />
    <FooterAttr />
  </div>
</template>

<script>
import FooterAttr from "./components/FooterAttr.vue";
